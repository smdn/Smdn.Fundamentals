...
public static class EventInfoExtensions {
  ...
  {
    var hasAddMethodCompilerGeneratedAttribute =
      ev.AddMethod is not null &&
      ev.AddMethod.HasCompilerGeneratedAttribute();
    var hasRemoveMethodCompilerGeneratedAttribute =
      ev.RemoveMethod is not null &&
      ev.RemoveMethod.HasCompilerGeneratedAttribute();

    return
      hasAddMethodCompilerGeneratedAttribute ||
      hasRemoveMethodCompilerGeneratedAttribute;
  }
