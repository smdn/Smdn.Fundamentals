...
#
# Summary:
#   Compares and generates differences between specified package's latest version and specified .nuspec.
#   The .nuspec file to be compared can be specified as a file directly or can be generated from the project.
#   The specified .nuspec file or project is always considered as the newer version.
#
# Parameters:
