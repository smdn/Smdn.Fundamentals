...
partial class UInt24Tests {
  ...
  public void TestOpSubtraction()
  {
    ...
    Assert.AreEqual(UInt24.MaxValue, UInt24.Zero - UInt24.One, "0 - 1");
    Assert.AreEqual(UInt24.One, UInt24.One - UInt24.Zero, "1 - 0");
    Assert.AreEqual(UInt24.Zero, UInt24.One - UInt24.One, "1 - 1");
    Assert.AreEqual(UInt24.One, UInt24.Zero - UInt24.MaxValue, "0 - Max");
  }
...
partial class UInt48Tests {
  ...
  public void TestOpSubtraction()
  {
    ...
    Assert.AreEqual(UInt48.MaxValue, UInt48.Zero - UInt48.One, "0 - 1");
    Assert.AreEqual(UInt48.One, UInt48.One - UInt48.Zero, "1 - 0");
    Assert.AreEqual(UInt48.Zero, UInt48.One - UInt48.One, "1 - 1");
    Assert.AreEqual(UInt48.One, UInt48.Zero - UInt48.MaxValue, "0 - Max");
  }
}
