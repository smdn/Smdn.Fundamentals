...
partial class MimeTypeTests {
  ...
  public void Equals_Object()
  {
    ...
    Assert.That(MimeType.TextPlain.Equals((object)new MimeType("TEXT/PLAIN")), Is.False, "MimeType");
    Assert.That(MimeType.TextPlain.Equals((object)"text/plain"), Is.True, "string");
    Assert.That(MimeType.TextPlain.Equals((object)"TEXT/PLAIN"), Is.False, "string");
...
#pragma warning disable CS0618
    => Assert.That(new MimeType(typeX, subtypeX).EqualsIgnoreCase(new MimeType(typeY, subtypeY)), Is.EqualTo(expected));
#pragma warning restore CS0618
...
#pragma warning disable CS0618
    => Assert.That(new MimeType(typeX, subtypeX).EqualsIgnoreCase(other), Is.EqualTo(expected));
#pragma warning restore CS0618
...
#pragma warning disable CS0618
    => Assert.That(new MimeType(typeX, subtypeX).TypeEqualsIgnoreCase(new MimeType(typeY, subtypeY)), Is.EqualTo(expected));
#pragma warning restore CS0618
...
#pragma warning disable CS0618
    => Assert.That(new MimeType(typeX, subtypeX).TypeEqualsIgnoreCase(typeY), Is.EqualTo(expected));
#pragma warning restore CS0618
...
#pragma warning disable CS0618
    => Assert.That(new MimeType(typeX, subtypeX).SubTypeEqualsIgnoreCase(new MimeType(typeY, subtypeY)), Is.EqualTo(expected));
#pragma warning restore CS0618
...
#pragma warning disable CS0618
    => Assert.That(new MimeType(typeX, subtypeX).SubTypeEqualsIgnoreCase(subtypeY), Is.EqualTo(expected));
#pragma warning restore CS0618
